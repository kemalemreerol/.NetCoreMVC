...
```
BlogSiteDesign Projem .NetCore 5.0 ile Geliştirilmiştir. Projemi inceleyecek olanlar .NetCore 5.0 ile inceleyebilirler. ( Bu projemi geliştirmekte yardımcı olan Murat Yücedağ Hocama Teşekkürlerimi Sunarım.)
